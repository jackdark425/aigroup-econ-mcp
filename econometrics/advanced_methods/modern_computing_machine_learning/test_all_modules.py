...
def test_random_forest():
    ...
    try:
        from econometrics.advanced_methods.modern_computing_machine_learning.random_forest import (
            EconRandomForest,
        ...
        rf_clf.fit(X, y_clf)
        rf_clf.predict(X)
        rf_clf.feature_importance()
        rf_clf.evaluate(X, y_clf)
        print("  Random Forest Classification: PASSED")

        # Test analysis function
        random_forest_analysis(X, y_reg, problem_type="regression")
        random_forest_analysis(X, y_clf, problem_type="classification")
...
def test_gradient_boosting():
    ...
    try:
        from econometrics.advanced_methods.modern_computing_machine_learning.gradient_boosting import (
        ...
        gb_reg = EconGradientBoosting(
            algorithm="sklearn", problem_type="regression", n_estimators=10
        )
        gb_reg.fit(X, y_reg)
        gb_reg.predict(X)
        gb_reg.feature_importance()
        gb_reg.evaluate(X, y_reg)
        print("  Gradient Boosting Sklearn Regression: PASSED")

        # Test sklearn classification
        gb_clf = EconGradientBoosting(
            algorithm="sklearn", problem_type="classification", n_estimators=10
        )
        gb_clf.fit(X, y_clf)
        gb_clf.predict(X)
        gb_clf.feature_importance()
        gb_clf.evaluate(X, y_clf)
        print("  Gradient Boosting Sklearn Classification: PASSED")

        # Test analysis function
        gradient_boosting_analysis(X, y_reg, algorithm="sklearn", problem_type="regression")
        gradient_boosting_analysis(X, y_clf, algorithm="sklearn", problem_type="classification")
...
def test_support_vector_machine():
    ...
    try:
        from econometrics.advanced_methods.modern_computing_machine_learning.support_vector_machine import (
            EconSVM,
            svm_analysis,
        )
        ...
        svm_clf.fit(X, y_clf)
        svm_clf.predict(X)
        svm_clf.predict_proba(X)
        svm_clf.evaluate(X, y_clf)
        print("  SVM Classification: PASSED")

        # Test analysis function
        svm_analysis(X, y_reg, problem_type="regression", C=0.1)
        svm_analysis(X, y_clf, problem_type="classification", C=0.1)
...
def test_neural_network():
    ...
    try:
        from econometrics.advanced_methods.modern_computing_machine_learning.neural_network import (
            EconNeuralNetwork,
        ...
        # Test regression
        nn_reg = EconNeuralNetwork(
            problem_type="regression", hidden_layer_sizes=(10,), max_iter=100
        )
        nn_reg.fit(X, y_reg)
        nn_reg.predict(X)
        nn_reg.evaluate(X, y_reg)
        print("  Neural Network Regression: PASSED")

        # Test classification
        nn_clf = EconNeuralNetwork(
            problem_type="classification", hidden_layer_sizes=(10,), max_iter=100
        )
        nn_clf.fit(X, y_clf)
        nn_clf.predict(X)
        nn_clf.predict_proba(X)
        nn_clf.evaluate(X, y_clf)
        print("  Neural Network Classification: PASSED")

        # Test analysis function
        neural_network_analysis(X, y_reg, problem_type="regression", hidden_layer_sizes=(10,))
        neural_network_analysis(X, y_clf, problem_type="classification", hidden_layer_sizes=(10,))
...
def test_kmeans_clustering():
    ...
    try:
        from econometrics.advanced_methods.modern_computing_machine_learning.kmeans_clustering import (
            EconKMeans,
            kmeans_analysis,
        )
        ...
        # Test analysis function
        kmeans_analysis(X, n_clusters=3)
...
def test_hierarchical_clustering():
    ...
    try:
        from econometrics.advanced_methods.modern_computing_machine_learning.hierarchical_clustering import (
        ...
        # Test analysis function
        hierarchical_clustering_analysis(X, n_clusters=3)
...
def test_double_ml():
    ...
    try:
        from econometrics.advanced_methods.modern_computing_machine_learning.double_ml import (
            DoubleML,
            double_ml_analysis,
        )
...
def test_causal_forest():
    ...
    try:
        from econometrics.advanced_methods.modern_computing_machine_learning.causal_forest import (
            CausalForest,
        ...
        cf.fit(X, y, w)
        cf.predict(X)
        cf.estimate_treatment_effect(X, y, w)
        print("  Causal Forest: PASSED")

        # Test analysis function
        causal_forest_analysis(X, y, w, n_estimators=10)
