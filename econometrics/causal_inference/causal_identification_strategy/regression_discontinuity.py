...
class RDDResult(BaseModel):
    ...
    bandwidth: float | None = Field(None, description="使用的带宽")
    polynomial_order: int | None = Field(None, description="多项式阶数")
    discontinuity_location: float | None = Field(None, description="断点位置")
