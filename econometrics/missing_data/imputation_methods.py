...
try:
    # Side-effect import: enables sklearn.impute.IterativeImputer (still
    # marked experimental upstream). Must precede the IterativeImputer import.
...
def simple_imputation(
    data: list[list[float]], strategy: str = "mean", fill_value: float | None = None
...
def multiple_imputation(
    ...
    for i in range(n_imputations):
        ...
        # 创建迭代插补器
        imputer = IterativeImputer(max_iter=max_iter, random_state=seed, verbose=0)
