...
def demo_usage():
    ...
    print("\n参数:")
    print(f"  file_content: {txt_example_single[:50]}...")
    print(f"  file_format: 'txt'")
    print("\n✅ 系统会自动:")
    print("  - 识别为单列数值格式")
    print("  - 将每行解析为一个数值")
    print("  - 适合时间序列分析")
    ...
    print("工具调用: descriptive_statistics")
    print("\n参数:")
    print(f"  file_content: {txt_example_multi[:80]}...")
    print(f"  file_format: 'txt'")
    print("\n✅ 系统会自动:")
    print("  - 检测空格分隔符")
    print("  - 识别表头（如果存在）")
    ...
    print("\n📝 示例8: TXT格式 - 键值对")
    print("-" * 60)
    print("工具调用: correlation_analysis")
    print("\n参数:")
    print(f"  file_content: {txt_example_keyvalue[:80]}...")
    print(f"  file_format: 'txt'")
    print("\n✅ 系统会自动:")
    print("  - 识别键值对格式（变量名: 数值列表）")
    print("  - 解析每个变量的数据")
    print("  - 适合配置文件式的数据组织")
